  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'ambient-drift-rev': 'ambient-drift-rev 18s ease-in-out infinite',
        'float-y': 'float-y 7s ease-in-out infinite',
        'fade-in-up': 'fade-in-up 0.5s ease-out forwards',
      },
      boxShadow: {
        'glow': '0 0 20px rgba(59, 130, 246, 0.1)',
        'card-teal': '0 25px 60px -15px rgba(4, 47, 46, 0.45), 0 0 40px rgba(20, 184, 166, 0.08)',
        'btn-glow': '0 0 20px rgba(16, 185, 129, 0.35)',
      },
    },
  },
