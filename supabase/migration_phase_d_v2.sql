/*
  PHASE D: DATABASE SCHEMA & SECURITY MIGRATION (V2 - ROBUST)
  ...
  V2 CHANGES:
  - Dynamic column checks for room_assignments (handles missing bed_id).
  - Dynamic column conversion for complaints priority (TEXT to INTEGER).
  - Dynamic column conversion for profiles role (TEXT to ENUM).
  - Safe rename/copy for rooms.monthly_rent to rooms.rent.
  - Corrected execution order to prevent "relation does not exist" errors.
*/
