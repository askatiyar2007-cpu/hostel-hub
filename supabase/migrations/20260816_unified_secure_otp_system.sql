...
GRANT EXECUTE ON FUNCTION public.request_otp(TEXT, TEXT, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.verify_otp(TEXT, TEXT, TEXT) TO authenticated;
