-- Migration: Allow Confirmed Duplicate Rooms in Bulk Creation
-- Date: 2026-09-03
-- Description: Update bulk_create_rooms to allow duplicate room numbers if explicitly approved
...
-- Add comment
COMMENT ON FUNCTION bulk_create_rooms IS 'Atomically create multiple rooms with beds in a single transaction. Allows duplicate room numbers if explicitly confirmed by owner.';
