/*
  PHASE D: DATABASE SCHEMA & SECURITY MIGRATION (V3 - FIXED ENUMS)
...
BEGIN
  ...
  -- 4.4 Migrate roles to user_roles
  ...
  -- 4.5 Migrate Assignments (DYNAMIC COLUMN CHECK)
  ...
  -- 4.6 Migrate Announcements to Notices
